...
export default function PerAppShell() {
      ...
      <header className="sticky top-0 z-30 w-full border-b border-white/10
        ...
        <div className="flex w-full items-center justify-between gap-4 px-4 md:px-8 py-3">
          ...
          <nav className="hidden md:flex items-center gap-2 lg:gap-6">
            {NavLinkBtn("/personal/#movies", "Movies", "movies")}
            {NavLinkBtn("/personal/#videogames", "Video Games", "videogames")}
            <Link
              to="/"
              className="rounded-lg px-3 py-2 font-semibold transition-colors hover:bg-white/10"
            >
              Professional
            </Link>
          </nav>
          ...
          <div className="md:hidden fixed inset-0 z-40">
            ...
            <div className="absolute right-0 top-0 w-[78%] max-w-sm p-3">
              ...
              >
                ...
                {NavLinkBtn("/#movies", "Movies", "movies")}
                {NavLinkBtn("/#videogames", "Video Games", "videogames")}
                <Link
                  to="/"
                  className="rounded-lg px-3 py-2 font-semibold transition-colors hover:bg-white/10"
                >
